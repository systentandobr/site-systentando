...
export const CollaborationSection = () => {
    return (
        <section id="collaboration" className="py-24 dark:bg-gradient-to-b dark:from-[#0d0d10] dark:to-[#0a0a0c] bg-gradient-to-b from-[#0d0d10] to-[#0a0a0c] dark:border-t dark:border-white/5 border-t border-white/5 relative z-10">
            <div className="container mx-auto px-6">
                <div className="bg-[#15151a] rounded-3xl p-8 md:p-12 border border-accent/20 relative overflow-hidden">
                    {/* Background pattern */}
                    <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(var(--accent) 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <p className="dark:text-slate-300 text-slate-300 text-lg mb-8">
                        ...
                        <div className="dark:bg-[#0a0a0c] bg-[#0a0a0c] p-8 rounded-2xl dark:border dark:border-white/10 border border-white/10">
                            <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                                <Code className="text-accent" />
                                Junte-se como Desenvolvedor
                            </h3>
                            <p className="dark:text-slate-400 text-slate-400 text-sm mb-6">
                            ...
                            <a href="https://github.com/systentandobr" target="_blank" rel="noopener noreferrer" className="block w-full text-center dark:bg-white bg-white dark:text-black text-black font-bold py-3 rounded-lg dark:hover:bg-slate-200 hover:bg-slate-200 transition-colors">
                                Acessar GitHub
                            </a>
                        </div>
                    </div>
